...
Judging by these couple plots, the standardized indexes of schools with low reported earnings seem to be higher than the ones with high reported earnings. Again, we are seeing that effect of in/out of research season on the standardized indexes. It's a bit difficult to see the effect of the availability of scorecard based on these plots.
...
m <- lm(index_std ~ w_scorecard*earning_lvl + research_season, data = weekly_trend2)
...
fe <- lm(index_std ~ w_scorecard*earning_lvl + research_season + factor(state), data = weekly_trend2)
